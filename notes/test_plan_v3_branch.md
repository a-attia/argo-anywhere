...
| T5 | D-030 uninstall preview | `argo-anywhere uninstall --dry-run --port 59999` | plan box shows "canonical install: n/a in package mode"; ends with the `pip`/`pipx` removal command |
